...
export async function submitCrawl(startUrl, render = false, { limit = 100_000, max_depth } = {}) {
...
export async function pollCrawlJobs(jobs) {
...
export async function crawl(startUrl, render = false, { limit = 100_000, max_depth, wait = true } = {}) {
...
export async function collectResults(jobId, initialResult, startUrl) {
