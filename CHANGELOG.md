...
- README badges switched from Codecov to GitLab-native pipeline and coverage badges. The Codecov badge pointed at a `codecov.io/gh/` path while the repository lives on GitLab, so it could not reflect this remote's state.
